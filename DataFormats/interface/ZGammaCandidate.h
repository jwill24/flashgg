#ifndef FLASHgg_ZGammaCandidate_h
#define FLASHgg_ZGammaCandidate_h
...
namespace flashgg {
    ...
    class ZGammaCandidate : public WeightedObject, public reco::CompositeCandidate
    {
    public:
        ZGammaCandidate();
        ZGammaCandidate( edm::Ptr<flashgg::Photon>, edm::Ptr<pat::Jet>, edm::Ptr<reco::Vertex> );
        ~ZGammaCandidate();
        ...
        void setZGammaPt( float val ) { photonjetPt_ = val; }
        ...
        bool operator <( const ZGammaCandidate &b ) const;
        bool operator >( const ZGammaCandidate &b ) const;
