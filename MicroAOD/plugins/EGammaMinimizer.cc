...
namespace flashgg {
    ...
    void EGammaMinimizer::produce( Event &evt, const EventSetup & )
    {
        ...
        evt.put( move( scColl ), superClusterCollectionName_ );
        evt.put( move( photonCoreColl ), photonCoreCollectionName_ );
        evt.put( move( photonColl ), photonCollectionName_ );
        evt.put( move( electronCoreColl ), electronCoreCollectionName_ );
        evt.put( move( electronColl ), electronCollectionName_ );
        ...
        evt.put( move( diPhotonColl ), diPhotonCollectionName_ );
    }
}
